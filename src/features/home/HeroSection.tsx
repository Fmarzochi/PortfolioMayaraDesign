  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex w-full flex-col gap-5 md:max-w-[56%] lg:max-w-[54%]">
          ...
          <div>
            <Link
              ...
              href="/projetos"
              className="btn-glass inline-flex items-center gap-3 rounded-full pl-5 pr-1.5 py-1.5 font-sans text-sm font-medium transition-all duration-200 hover:opacity-80"
        ...
        {/* Badge circular mobile — visível apenas em mobile (< md) */}
        <div
          aria-hidden="true"
